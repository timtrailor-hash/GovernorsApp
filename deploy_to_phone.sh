#!/bin/bash
# deploy_to_phone.sh — Build and install GovernorsApp to the connected iPhone.
...
echo "=== Building GovernorsApp ==="
xcodebuild -scheme GovernorsApp \
...
APP_PATH=$(find ~/Library/Developer/Xcode/DerivedData/GovernorsApp-*/Build/Products/Debug-iphoneos/GovernorsApp.app -maxdepth 0 2>/dev/null | head -1)
if [[ -z "$APP_PATH" ]]; then
...
echo "=== Done! GovernorsApp installed ==="
